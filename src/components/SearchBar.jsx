...
const SearchBar = () => {
  ...
  return (
    <div className={`relative  ${isExpanded ? "w-full " : ""}`}>
      {/* Compact Search Icon */}
      <div
        className="flex items-center gap-2 bg-gray-100  justify-start hover:bg-gray-300 rounded-full px-2 md:px-2 w-36 py-1.5 transition-all duration-300 cursor-pointer"
